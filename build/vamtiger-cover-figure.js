!function() {
    ...
    function(e) {
        e.captionImage = "captionImage",
        e.imageCaptionIcon = "imageCaptionIcon",
        e.imageCaptionTitle = "imageCaptionTitle",
    ...
    function(e) {
        ...
        e.overlay = "div",
        e.figure = "figure",
        e.imageCaption = "[data-image-caption]",
        e.icon = "[data-icon]",
        e.titleHeader = "[data-title-header]",
        e.title = "[data-title]",
        e.subtitle = "[data-subtitle]",
        e.centerCaption = "[data-center-caption]",
        e.captionImage = "img, svg",
        e.vamtigerResponsiveSvg = "vamtiger-responsive-svg",
        e.iconFigure = "[data-icon-figure]",
        e.linkedDataCaption = "[data-linked-data-caption]",
        e.linkedDataCaptionElement = "[data-linked-data-caption-element]",
        e.a = "a"
    }(o || (o = {})),
    function(e) {
        e.image = "image",
    ...
    const {nothing: m} = t
      ...
      , v = ["<style>:host{display:grid;position:relative;overflow:hidden}\n/*# sourceMappingURL=index.ts.map */</style>", p].join(m);
    f.innerHTML = v;
    var u = e=>{
        const {selector: t, attributes: a={}, properties: i={}} = e
          , o = Object.keys(a)
          , r = f.content.querySelector(t)
          , n = r && r.cloneNode(!0);
        return n && (Object.assign(n, i),
        o.forEach(e=>a[e] && n.setAttribute(e, a[e] || ""))),
        n
    }
    ;
    const {VamtigerBrowserMethod: b} = window
      , {getData: y} = b
      , {nothing: h} = t
      , {captionLoaded: w} = a;
    const {nothing: k} = t
    ...
    function C({currentTarget: t, element: a}) {
        const i = t
          , s = a || i.closest(O)
          , c = s.dataset
          , l = new CustomEvent(n.imageLoaded,x);
        i.removeEventListener("loaded", C),
        c.loaded = k,
        ...
        function({element: t}) {
            e(this, void 0, void 0, function*() {
                const e = t.dataset
                  ...
                  , g = c && c.description
                  , p = d && g && l && u({
                    selector: o.vamtigerResponsiveSvg,
                    attributes: {
                        "data-json-ld": l
                    }
                })
                  , m = p && u({
                    selector: o.iconFigure
                })
                  , f = d && u({
                    selector: o.titleHeader,
                    attributes: {
                        "data-json-ld": l
                    }
                })
                  ...
                  , k = [m, f, b]
                  , x = k.every(e=>Boolean(e)) && u({
                    selector: o.imageCaption,
                    attributes: {
                        slot: r.caption
                    }
                });
                p && m && (p.addEventListener(n.svgLoaded, function e() {
                    p && p.removeEventListener(n.svgLoaded, e),
                    x && setTimeout(()=>x.dataset.loaded = h, w)
                }),
                m.appendChild(p)),
                v && d && (v.innerHTML = d),
                f && f.setAttribute("itemprop", "name"),
                b && b.setAttribute("itemprop", "description"),
                x && (k.forEach(e=>e && x.appendChild(e)),
                t.appendChild(x))
            })
        }({
            element: s
    ...
    const {VamtigerBrowserMethod: L, requestIdleCallback: j} = self
      , {getData: E, getMicrodataCaption: z} = L
      , {slash: D, nothing: M} = t;
    function S({element: t}) {
        return e(this, void 0, void 0, function*() {
            const e = t.dataset
              ...
              , c = r && r.keywords
              , l = r && r.about
              , d = (l["@context"] && l["@type"] && [l["@context"], l["@type"]].join(D),
            l && l.name,
            l && l.description,
            r && u({
                selector: o.linkedDataCaption
            }))
              , g = (l && u({
                selector: o.linkedDataCaption,
                attributes: {
            ...
            d && [n && u({
                selector: o.linkedDataCaptionElement,
                properties: {
                    innerHTML: n
                },
                attributes: {
            ...
            d && g && g.length && (g.forEach(e=>e && d.appendChild(e)),
            t.appendChild(d))
        })
    }
    const {VamtigerBrowserMethod: T} = window
      , {getData: H} = T
      , {nothing: I, colonSpace: A, slash: B} = t;
    function K({element: t}) {
        return e(this, void 0, void 0, function*() {
            const e = t.dataset
              , {image: a, overlay: i, jsonLd: r} = e
              , {jsonLd: n} = r && (yield H({
                jsonLd: r
            })) || {
                jsonLd: []
            ...
            var b;
            m && f && (m.addEventListener("load", C),
            f.appendChild(m),
            t.appendChild(f),
            t.dataset.loading = I,
            m.setAttribute("itemprop", "image")),
            v && v.forEach(e=>{
                e && (e.dataset.overlay = I,
                t.appendChild(e))
            }
            ),
            g && p.forEach(e=>t.setAttribute(e, g[e])),
            b = {
                element: t
            },
            new Promise((e,t)=>{
    ...
    const O = "vamtiger-cover-figure"
      , {VamtigerBrowserMethod: V} = window
      , {loadScript: R} = V;
    R({
        name: O,
        css: g
    }).catch(console.error);
    const {VamtigerBrowserMethod: q} = window
      , {defineCustomElement: P, loadScript: $} = q
      , F = {
        name: O,
        constructor: class extends HTMLElement {
            constructor() {
                super();
                const {dataset: e} = this
                  , {overlay: t, template: a} = e
                  , i = this.attachShadow(c);
                [u({
                    selector: o.style
                }), u({
                    selector: o.slot,
                    ...
                    selector: o.slot,
                    properties: {
                        name: r.centerCaption
                    }
                })].forEach(e=>e && i.appendChild(e))
            }
