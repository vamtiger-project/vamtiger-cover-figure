...
const vamtigerBrowserMethod = {
    source: path.resolve(__dirname, '../../node_modules/vamtiger-browser-method/build/vamtiger-browser-method.js'),
    destination: path.resolve(__dirname, '../../build/vamtiger-browser-method.js')
};
